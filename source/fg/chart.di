 ...
 */
fg_err fg_create_chart (fg_chart* pHandle, const fg_chart_type pChartType);
...
/**
   ...
   \return \ref fg_err error code
 */
fg_err fg_set_chart_axes_titles (
    fg_chart pHandle,
    const(char)* pX,
    const(char)* pY,
    const(char)* pZ);
 ...
 */
fg_err fg_set_chart_axes_limits (
    fg_chart pHandle,
    const float pXmin,
    const float pXmax,
    const float pYmin,
 ...
 */
fg_err fg_set_chart_label_format (
    fg_chart pHandle,
    const(char)* pXFormat,
    const(char)* pYFormat,
    const(char)* pZFormat);
...
/**
   ...
   \param[in] pHandle is chart handle
 */
fg_err fg_get_chart_axes_limits (
    float* pXmin,
    float* pXmax,
    float* pYmin,
    float* pYmax,
...
/**
   ...
   \return \ref fg_err error code
 */
fg_err fg_add_histogram_to_chart (
...
/**
   ...
   \return \ref fg_err error code
 */
fg_err fg_add_surface_to_chart (
    fg_surface* pSurface,
    fg_chart pHandle,
    const uint pXPoints,
    const uint pYPoints,
...
/**
   ...
   \return \ref fg_err error code
 */
fg_err fg_add_vector_field_to_chart (
...
\return \ref fg_err error code
*/
fg_err fg_remove_image_from_chart (fg_chart pHandle, fg_image pImage);
...
\return \ref fg_err error code
*/
fg_err fg_remove_histogram_from_chart (
    fg_chart pHandle,
    fg_histogram pHistogram);
...
\return \ref fg_err error code
*/
fg_err fg_remove_plot_from_chart (fg_chart pHandle, fg_plot pPlot);
...
\return \ref fg_err error code
*/
fg_err fg_remove_surface_from_chart (fg_chart pHandle, fg_surface pSurface);
...
\return \ref fg_err error code
*/
fg_err fg_remove_vector_field_from_chart (
    fg_chart pHandle,
    fg_vector_field pField);
